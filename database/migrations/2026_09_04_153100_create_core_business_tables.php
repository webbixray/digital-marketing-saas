...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('plans', function (Blueprint $table) {
            ...
            $table->unsignedInteger('social_accounts')->nullable()->default(1);
            $table->unsignedInteger('posts_per_month')->nullable()->default(30);
            $table->unsignedInteger('campaigns')->nullable()->default(1);
            $table->unsignedInteger('clients')->nullable()->default(0);
            $table->unsignedInteger('ai_requests_per_month')->nullable()->default(50);
            $table->unsignedInteger('ai_generations_per_month')->nullable()->default(20);
            $table->unsignedInteger('landing_pages')->nullable()->default(0);
            $table->unsignedInteger('forms')->nullable()->default(0);
