...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white m-0">Referral Program</h1>
    </div>
    <div class="flex items-center justify-start sm:justify-end">
        <ol class="flex gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li>/</li>
            <li class="text-gray-900 dark:text-white font-medium">Referrals</li>
        </ol>
    </div>
</div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border border-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Joined</th>
                        ...
                        <tbody>
                            @foreach($stats['referrals'] as $referral)
                                <tr>
                                    ...
                                    <td class="px-4 py-2">{{ $referral['joined_at'] }}</td>
                                    <td class="px-4 py-2">
                                        @if($referral['paid'])
