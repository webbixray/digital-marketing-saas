...
@section('title', 'Twitter / X Integration')
...
<div class="space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Twitter / X Integration</h1>
        </div>
        <div class="flex items-center justify-start sm:justify-end">
            <ol class="flex gap-2 text-sm text-gray-500 justify-end">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-6">
                    <p class="text-gray-600 dark:text-gray-400 mb-4">Connect your Twitter account to enable:</p>
                    ...
                    <a href="{{ route('twitter.connect') }}" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 inline-flex items-center gap-2 font-medium transition-colors">
                        <i class="fab fa-twitter"></i> Connect Twitter Account
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="p-6">
                    <form action="{{ route('twitter.post') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="account_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Select Account</label>
                        ...
                        <div class="mb-4">
                            <label for="text" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tweet Text</label>
                ...
                <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <i class="fab fa-twitter text-indigo-600 dark:text-indigo-400 mr-2"></i>
                                    {{ $account->platform_display_name }}
                                </td>
                                <td>
                                    <a href="https://twitter.com/{{ $account->platform_username }}" target="_blank" class="text-indigo-600 hover:text-indigo-700 dark:text-indigo-400">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('twitter.disconnect', $account->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
