...
@section('content')
 ...
 <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
  <div class="stat-bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700 border-l-4 border-green-500">
  ...
  <div class="stat-bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700 border-l-4 border-yellow-500">
   <div class="flex items-center gap-4">
  ...
  <div class="stat-bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700 border-l-4 border-red-500">
   <div class="flex items-center gap-4">
