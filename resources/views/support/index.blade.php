...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-12 gap-4 mb-2">
        <div class="col-span-12 sm:col-span-6">
            <h1 class="m-0 text-2xl font-bold text-gray-900 dark:text-white">Support Tickets</h1>
        </div>
        <div class="col-span-12 sm:col-span-6 flex items-center justify-end">
            <ol class="flex gap-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <li>/</li>
                <li class="text-gray-900 dark:text-white font-medium">Support</li>
            </ol>
        </div>
    </div>
