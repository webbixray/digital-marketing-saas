...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="font-semibold text-gray-900 dark:text-white">Create Template</h3>
        </div>
        <form action="{{ route('content-templates.store') }}" method="POST">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" class="form-input" value="{{ old('name') }}" required placeholder="Template name">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="content" id="content" class="form-input" rows="12" placeholder="Write your template content here... Use variables like @{{ name }}, @{{ email }}, etc.">{{ old('content') }}</textarea>
                </div>
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_public" id="is_public" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600" value="1" {{ old('is_public') ? 'checked' : '' }}>
