...
<div class="max-w-2xl mx-auto">
    <nav class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
        ...
        <span>/</span>
        <span class="text-gray-900 dark:text-white">Edit: {{ $field->name }}</span>
    </nav>
    <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="font-semibold text-gray-900 dark:text-white">Edit Custom Field</h3>
        </div>
        <form action="{{ route('custom-fields.update', $field) }}" method="POST">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" class="form-input" value="{{ old('name', $field->name) }}" required placeholder="Field name">
                </div>
                <div>
                ...
                <div>
                    ...
                    <textarea name="options" id="options" class="form-input" rows="4" placeholder="Option 1&#10;Option 2&#10;Option 3">{{ old('options', $field->options) }}</textarea>
                </div>
                <div class="flex items-center gap-2">
                    <input type="checkbox" name="is_required" id="is_required" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600" value="1" {{ old('is_required', $field->is_required) ? 'checked' : '' }}>
