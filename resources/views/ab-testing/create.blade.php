...
@section('content')
 ...
 <div class="grid grid-cols-12 gap-4 justify-center><div class="col-span-12 lg:col-span-10">
  <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
   ...
   <div class="p-6">
    <div class="grid grid-cols-12 gap-4><div class="col-span-12 md:col-span-8">
     <div class="mb-4">
     <label for="name">Test Name <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <div class="col-span-12 md:col-span-4">
     <div class="mb-4">
     <label for="type">Test Type <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <div class="grid grid-cols-12 gap-4><div class="col-span-12 md:col-span-6">
     <div class="mb-4">
     <label for="social_account_id">Social Account <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <div class="col-span-12 md:col-span-6">
     <div class="mb-4">
     <label for="platform">Platform <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <div class="mb-4">
    <label for="sample_size">Sample Size (per variant) <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <small class="text-sm text-gray-500 dark:text-gray-400 text-gray-500 dark:text-gray-400">Minimum 50 per variant. Recommended: 100-500 for statistical significance.</small>
    ...
    <div class="grid grid-cols-12 gap-4><div class="col-span-12 md:col-span-6">
     ...
     <div class="p-6">
      <div class="mb-4">
      <label for="variant_a_content">Content <span class="text-red-600 dark:text-red-400">*</span></label>
    ...
    <div class="col-span-12 md:col-span-6">
     ...
     <div class="p-6">
      <div class="mb-4">
      <label for="variant_b_content">Content <span class="text-red-600 dark:text-red-400">*</span></label>
