    ...
    <form action="{{ route('landing-pages.update', $page) }}" method="POST">@csrf @method('PUT')
        <div class="p-6">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 md:col-span-6"><div class="mb-4"><label>CTA Text</label><input type="text" name="cta_text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->cta_text }}"></div></div>
                <div class="col-span-12 md:col-span-6"><div class="mb-4"><label>CTA URL</label><input type="url" name="cta_url" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->cta_url }}"></div></div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 md:col-span-3"><div class="mb-4"><label>Background</label><input type="color" name="background_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->background_color }}"></div></div>
                <div class="col-span-12 md:col-span-3"><div class="mb-4"><label>Text Color</label><input type="color" name="text_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->text_color }}"></div></div>
                <div class="col-span-12 md:col-span-3"><div class="mb-4"><label>Button Color</label><input type="color" name="button_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->button_color }}"></div></div>
                <div class="col-span-12 md:col-span-3"><div class="mb-4"><label>Button Text</label><input type="color" name="button_text_color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" value="{{ $page->button_text_color }}"></div></div>
            </div>
        </div>
