            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('social.accounts.edit', $account) }}" class="btn btn-sm btn-secondary flex-1">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <form method="POST" action="{{ route('social.accounts.destroy', $account) }}" class="inline">
                            @csrf @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Disconnect this account?')">
