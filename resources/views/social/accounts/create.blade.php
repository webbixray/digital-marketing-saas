    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700"><h3 class="font-semibold text-gray-900 dark:text-white">Connect Social Account</h3></div>
                <form action="{{ route('social.accounts.store') }}" method="POST">
                    ...
                    <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex items-center gap-2">
                        <button class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 inline-flex items-center gap-2 font-medium transition-colors"><i class="fas fa-plug mr-1"></i> Connect</button>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700"><h3 class="font-semibold text-gray-900 dark:text-white">Instructions</h3></div>
                <div class="p-6">
                    <p>Enter your platform access token to connect your account. You can get this token from the platform's developer console.</p>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">All credentials are encrypted and stored securely.</p>
                </div>
            </div>
        </div>
    </div>
