...
@section('breadcrumb')
    ...
    <li><a href="{{ route('tiktok.index') }}" class="hover:text-gray-700 dark:hover:text-gray-200">Integration</a></li>
@endsection

@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">TikTok Integration</h1>
        ...
        @if($tiktokAccounts->isEmpty())
            <p class="text-gray-600 dark:text-gray-400 mb-4">No TikTok accounts connected.</p>
