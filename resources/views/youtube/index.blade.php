...
@section('breadcrumb')
    ...
    <li><a href="{{ route('youtube.index') }}" class="hover:text-gray-700 dark:hover:text-gray-200">Integration</a></li>
@endsection

@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">YouTube Integration</h1>
        ...
        @if($youtubeAccounts->isEmpty())
            <p class="text-gray-600 dark:text-gray-400 mb-4">No YouTube channels connected.</p>
        ...
        @else
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Connected Channels</h2>
            <ul class="space-y-2">
