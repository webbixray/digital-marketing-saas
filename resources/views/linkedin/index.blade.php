...
@section('title', 'LinkedIn Integration')

@section('breadcrumb')
    <li><i class="fas fa-chevron-right text-[10px]"></i></li>
    <li><a href="{{ route('linkedin.index') }}" class="hover:text-gray-700 dark:hover:text-gray-200">Integration</a></li>
@endsection

@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">LinkedIn Integration</h1>
        ...
        @if($linkedinAccounts->isEmpty())
            <p class="text-gray-600 dark:text-gray-400 mb-4">No LinkedIn accounts connected.</p>
