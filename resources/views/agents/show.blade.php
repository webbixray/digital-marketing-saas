...
<!-- Agent Info Card -->
 ...
 <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
  ...
  <div class="text-center mb-3">
   <div class="fa-3x text-indigo-600 dark:text-indigo-400 mb-2">
  ...
  <div>
   ...
   <span class="badge bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-gray-600 dark:text-gray-300 mb-1">{{ str_replace('_', ' ', $type) }}</span>
   @empty
  ...
  <a href="{{ route('agents.dashboard') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 inline-flex items-center gap-2 font-medium transition-colors text-gray-700 dark:text-gray-200 px-3 py-1.5 text-sm">
 ...
 <!-- Performance Metrics -->
 <div class="grid grid-cols-12 gap-4><div class="col-span-12 md:col-span-4">
 ...
 <div class="grid grid-cols-12 gap-4><div class="col-span-12 md:col-span-6">
  <div class="bg-white rounded-xl shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
   ...
   <div class="p-6">
   <div class="space-y-2">
    <span class="text-sm text-gray-600 dark:text-gray-400">Speed Score</span>
    <span class="ml-auto"><b>{{ number_format(($agent['speed_score'] ?? 0.5) * 100) }}%</b></span>
   ...
   <div class="space-y-2">
    ...
    <span class="ml-auto"><b>{{ number_format(($agent['cost_score'] ?? 0.5) * 100) }}%</b></span>
    <div class="w-full bg-gray-200 rounded-full h-1.5 dark:bg-gray-700">
   ...
   <div class="space-y-2">
    ...
    <span class="ml-auto"><b>${{ number_format($agent['total_cost'] ?? 0, 4) }}</b></span>
   </div>
   <div class="space-y-2">
    <span class="text-sm text-gray-600 dark:text-gray-400">Total Successes</span>
    <span class="ml-auto"><b>{{ number_format($agent['total_successes'] ?? 0) }}</b></span>
   </div>
   </div>
  </div>
  </div>
